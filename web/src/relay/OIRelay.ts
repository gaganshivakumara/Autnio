...
export type RelayStatus = "idle" | "connecting" | "connected" | "closed" | "error" | "reconnecting";

/** Convenience function used by RelayPage — creates, connects, and returns the relay. */
